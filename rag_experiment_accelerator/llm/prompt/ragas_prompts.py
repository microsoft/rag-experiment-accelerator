...
ragas_answer_relevance_instruction = Prompt(
    system_message="ragas_answer_relevance_instruction.txt",
    user_template="${text}",
    tags={PromptTag.NonStrict},
)

ragas_context_precision_instruction = StructuredPrompt(
    system_message="ragas_context_precision_instruction.txt",
    user_template=_context_precision_input,
    validator=validate_context_precision,
    tags={PromptTag.NonStrict},
)

ragas_context_recall_instruction = StructuredPrompt(
    system_message="ragas_context_recall_instruction.txt",
