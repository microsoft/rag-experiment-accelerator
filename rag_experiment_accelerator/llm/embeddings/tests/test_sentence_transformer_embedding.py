...
import pytest
import numpy as np
from rag_experiment_accelerator.llm.embeddings.sentence_transformer_embedding import (
    SentenceTransformerEmbeddingModel,
)


@patch(
    "rag_experiment_accelerator.llm.embeddings.sentence_transformer_embedding.SentenceTransformer.encode"
)
