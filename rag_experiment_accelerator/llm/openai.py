import openai
from rag_experiment_accelerator.llm.base import LLMModelBase, EmbeddingModel
from rag_experiment_accelerator.utils.auth import OpenAICredentials

from rag_experiment_accelerator.utils.logging import get_logger
logger = get_logger(__name__)

class OpenAIModel(LLMModelBase):

    def __init__(self, model_name: str, tags: list[str], openai_creds: OpenAICredentials) -> None:
