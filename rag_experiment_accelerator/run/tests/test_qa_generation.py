...
def test_run(
    ...
    mock_config.sample_input_data_csv_path = sampled_input_data_csv_path
    ...
    # Act
    run(mock_environment, mock_config, filepaths, sampled_input_data_csv_path)

    # Assert
    mock_exists.assert_called_once_with(sampled_input_data_csv_path)
