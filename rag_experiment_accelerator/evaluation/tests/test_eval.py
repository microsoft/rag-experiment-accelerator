...
from rag_experiment_accelerator.evaluation.eval import ragas_answer_relevance
from rag_experiment_accelerator.evaluation.eval import ragas_context_precision
...
# TODO: Look into feeding in eval_data.jsonl to test ragas_answer_relevance
...
def test_ragas_answer_relevance():
    # filepath = /artifacts/eval_data.jsonl
    # read from that
    # for each line, call ragas_answer_relevance
    ...
    score = ragas_answer_relevance(question, answer, context)
    assert score == [0.743114833440214]
