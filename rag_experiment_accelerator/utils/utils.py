...
def mask_string(s: str, start: int = 2, end: int = 2, mask_char: str = "*") -> str:
    """
...
def get_env_var(var_name: str, critical: bool, mask: bool) -> str:
    """
    ...
    if var is None:
        ...
        text = var if not mask else mask_string(var)
