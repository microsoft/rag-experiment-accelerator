...
class Config:
    ...
    Attributes:
        ...
        AZURE_EMBEDDING_DEPLOYMENT_NAME (str): The name of the Azure deployment to use for embeddings.
    ...
    def __init__(self, config_filename: str = 'search_config.json') -> None:
        ...
        self.AZURE_EMBEDDING_DEPLOYMENT_NAME = data.get("azure_embedding_deployment_name", None)
