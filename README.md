...
OPENAI_API_TYPE is `azure` for Azure OpenAI or  `open_ai` for OpenAI. This value is required when running `01_index.py`, `02_qa_generation.py`, and `03_querying.py`.
