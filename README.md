...
```json
{
    ...
    "eval_data_jsonl_file_path": "File path for eval data jsonl file which is input for 03_querying script. Use default value of './artifacts/eval_data.jsonl' to use jsonl file generated by 02_qa_generation.py"
}
```
