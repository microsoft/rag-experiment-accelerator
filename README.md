...
3. Execute the requirements.txt in a conda (first install [Anaconda/Miniconda](https://docs.conda.io/projects/miniconda/en/latest/)) or virtual environment (then install a couple of dependencies - prompted on the run) to install the dependencies.

```bash
# Miniconda installation scripts
